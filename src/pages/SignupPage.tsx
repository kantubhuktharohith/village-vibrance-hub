  ...
  return (
    <div className="min-h-screen bg-background px-6 pt-16 pb-8">
      ...
      >
        ...
        <h1 className="font-display text-3xl font-bold mb-2">Join VillageConnect</h1>
        <p className="text-muted-foreground mb-8">
          Create your account to book verified rural experiences
        </p>
        ...
        <div className="space-y-3 mb-6">
          {methods.map((m) => (
            ...
            >
              ...
              <span className="font-medium">Continue with {m.label}</span>
            </button>
          ))}

          <button className="w-full flex items-center gap-3 p-4 rounded-xl border-2 border-border hover:border-muted-foreground/30 transition-all">
        ...
        {method && (
          ...
          >
            <input
              ...
              placeholder={method === "email" ? "your@email.com" : "+91 XXXXX XXXXX"}
